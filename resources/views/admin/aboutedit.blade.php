...
<div class="container-fluid px-4">
    <h1 class="mt-4">Biz Haqimizda Yangilash</h1>
        ...
        <div class="col-lg-8 card-body p-4">
            <form method="post" action="{{ route('about.update', $abouts->id) }}" id="edit-form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Nomini Kiriting" value="{{ $abouts->title }}" required>
                </div>
                <div class="mb-3">
                    <label for="content">Kontent</label>
                    <textarea class="form-control" id="content" name="content" placeholder="Kontentni Kiriting" required>{{ $abouts->content }}</textarea>
                </div>
                <div class="mb-3">
